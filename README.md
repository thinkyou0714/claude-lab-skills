...
| [lab-strategy-design](./lab-strategy-design/) | 目標検証・代替案比較・スコープ設計 | 6 | — |
...
| [lab-implementation-flow](./lab-implementation-flow/) | 実装ゲート・影響範囲・施工AIへの handoff | 6 | `/impl-gate` |
| [lab-communication-translation](./lab-communication-translation/) | 非エンジニア翻訳・ドキュメント再利用性 | 5 | `/translate` |
